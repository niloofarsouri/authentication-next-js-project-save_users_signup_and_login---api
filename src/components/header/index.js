        ...
        <>
            <header className="flex w-full h-auto mb-2 md:mb-5">
                <div className="w-full h-auto flex justify-between">
                    ...
                    <ul className="flex justify-center">
                        <Link href={'/login'}>
                            <li className='p-3 shadow-header hover:bg-slate-50 hover:text-sky-800 cursor-pointer'>Login</li>
                        </Link>

                        <Link href={'/signup'}>
                            <li className='p-3 shadow-header hover:bg-slate-50 hover:text-sky-800 cursor-pointer'>Sign Up</li>
                        </Link>
                    </ul>
